* possibly collapse territory into regions
...
* possibly collapse factor variables with very sparse levels depending on predictive performance (ex. application_type)
